...
var previousY = 0;  // Store previous player Y position for comparison
...
// Other game-related variables (from original code)
...
// init game
var bgcolor = "#0077be";  
var forecolor = "#003366"; 
var linecolor = "#002244"; 
var linewidth = 5;
var offset = -10;
var yRatio = .3;
var t = 0;
...
// player object and other game settings
var player = new function(){
    this.x = c.width / 2;
    this.y = 50;
    this.truck = new Image();
    this.truck.src = "shep.png";
    this.rot = 0;
    this.ySpeed = 0;
    this.rSpeed = 0;
    ...
    this.drawInterface = function(){
        if(playing){
            ...
            ctx.fillStyle = "white";
            ctx.font = "24px Arial";
            ctx.fillText("Xal: " + score, 20, 40);  // Xalı sol üst küncdə göstər
        } else {
            // "Oyun Bitti" mesajı və oyunun avtomatik yenilənməsi
    ...
    this.draw = function(){
        ...
        // Check if player has made progress for scoring
        if (this.y < previousY) {
            score += 1;  // Increase score as player moves up
        }
        previousY = this.y;

        // Drawing the player (truck image)
        ctx.save();
...
// Mobile controls (same as previous code)
if(mobilmi){
    ...
    // Desktop controls (same as previous code)
